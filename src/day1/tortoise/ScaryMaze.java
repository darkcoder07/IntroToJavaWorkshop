...
int ScareColor = -12450811;
int WinColor = -16735272;
		...
		{scare();}
			...
			JOptionPane.showMessageDialog(null, "Congratulations. You beat The Scary Maze");
			}
	}
	...
	private void scare() {
		...
		AudioClip sound = JApplet.newAudioClip(getClass().getResource("194215__xdimebagx__horror-jumpscare-monstersighting.wav"));
...
showScaryImage("jumpscare 2.jpg");
	}
